...
var $author$project$Invoice$viewFields = function (invoice) {
	var width = $elm$core$String$fromFloat(invoice.width * 100) + '%';
	var top = $elm$core$String$fromFloat(invoice.top * 1000) + 'px';
	var left = $elm$core$String$fromFloat(invoice.left * 100) + '%';
	var height = $elm$core$String$fromFloat(invoice.height * 1000) + '%';
	var fieldLabel = (invoice.chars === '') ? 'Invoice: ' : invoice.chars;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Invoice Processor')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Let\'s parse some invoices!')
							]))
					])),
				A2(
				$elm$html$Html$div,
